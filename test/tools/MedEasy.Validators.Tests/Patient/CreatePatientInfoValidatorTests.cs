...
namespace MedEasy.Validators.Tests.Patient
{
    ...
    public class CreatePatientInfoValidatorTests : IDisposable
    {
        ...
        public async Task Should_Fails_PatientInfo_With_Empty_Main_Doctor_Id()
        {
            ...
            _uowFactoryMock.Verify(mock => mock.New().Repository<Objects.Doctor>().AnyAsync(It.IsAny<Expression<Func<Objects.Doctor, bool>>>(), It.IsAny<CancellationToken>()), Never);
        }
        ...
        public async Task Should_Failed_When_PatientInfo_With_Unknown_Main_Doctor_Id()
        {
            ...
            _uowFactoryMock.Setup(mock =>
                        mock.New().Repository<Objects.Doctor>()
                        .AnyAsync(It.IsAny<Expression<Func<Objects.Doctor, bool>>>(), It.IsAny<CancellationToken>()))
