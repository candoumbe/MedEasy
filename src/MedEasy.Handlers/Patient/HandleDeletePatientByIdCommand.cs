...
namespace MedEasy.Handlers.Patient.Commands
{
    ...
    /// </summary>
    public class HandleDeletePatientByIdCommand : IHandleDeletePatientByIdCommand
    {
        /// <summary>
        ...
        public HandleDeletePatientByIdCommand(IValidate<IDeletePatientByIdCommand> validator, ILogger<HandleDeletePatientByIdCommand> logger, IUnitOfWorkFactory factory,
        ...
        public Task<bool> RunAsync(IDeletePatientByIdCommand command)
        {
