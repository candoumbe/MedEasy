...
namespace MedEasy.Validators
{
    ...
    /// </summary>
    public class ValidatePatchPatientCommand : IValidate<IPatchCommand<int, Objects.Patient>>
    {
        public IEnumerable<Task<ErrorInfo>> Validate(IPatchCommand<int, Objects.Patient> command)
        {
            ...
            {
                yield return Task.FromResult(new ErrorInfo(nameof(IPatchInfo<int, Objects.Patient>.PatchDocument), $"{nameof(IPatchInfo<int, Objects.Patient>.PatchDocument)}", Error));
            }
            ...
            { 
                ...
                {
                    yield return Task.FromResult(new ErrorInfo(nameof(PatchInfo<int, Objects.Patient>.PatchDocument), "Change the ID is not allowed", Error));
                }
            }        
