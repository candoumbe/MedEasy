...
namespace MedEasy.Mobile.Core.ViewModels
{
    ...
    public class SignInViewModel : ViewModelBase
    {
        ...
        public SignInViewModel(ITokenApi tokenApi, INavigatorService navigationService)
        {
            ...
            LostPasswordCommand = new Command(async () => await navigationService.PushModalAsync(new LostPasswordViewModel(navigationService){ Email = Login }));
