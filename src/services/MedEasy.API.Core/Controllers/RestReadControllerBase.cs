...
namespace MedEasy.API.Core.Controllers
{
    ...
    public abstract class RestReadControllerBase<TOptions, TKey, TResource> : AbstractBaseController, IRestReadController<TKey>
        ...
        where TOptions : ApiOptions
    {
        ...
        /// </summary>
        protected IOptionsSnapshot<TOptions> ApiOptions { get; }
