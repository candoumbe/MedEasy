...
using MedEasy.Commands.BloodPressure;
using MedEasy.DAL.Repositories;
using MedEasy.Data;
using MedEasy.DTO;
using MedEasy.Objects;
using MedEasy.Queries.BloodPressure;
...
using MedEasy.Handlers.Core.BloodPressure.Commands;
using MedEasy.Handlers.Core.Search.Queries;
using MedEasy.Handlers.Core.BloodPressure.Queries;
...
namespace MedEasy.Measures.API.Controllers
{
    ...
    public class BloodPressuresController : RestCRUDControllerBase<Guid, BloodPressure, BloodPressureInfo, IWantOneResource<Guid,Guid,  BloodPressureInfo>, IWantPageOfResources<Guid, BloodPressureInfo>, Guid, CreatePhysiologicalMeasureInfo<BloodPressure>,  ICreateBloodPressureCommand, IRunCreateBloodPressureCommand>
    {
        /// <summary>
        ...
        private readonly IRunCreateBloodPressureCommand _iRunCreateBloodPressureCommand;
        private readonly IRunDeleteBloodPressureByIdCommand _iRunDeleteBloodPressureByIdCommand;

        private readonly IRunPatchBloodPressureCommand _iRunPatchBloodPressureCommmand;
        private readonly IMapper _mapper;
        private readonly IHandleSearchQuery _iHandleSearchQuery;
        private readonly IHandleGetDocumentsByBloodPressureIdQuery _iHandleGetDocumentByBloodPressureIdQuery;
        ...
        /// <param name="getManyBloodPressureQueryHandler">Handler of GET many <see cref="BloodPressureInfo"/> resources</param>
        /// <param name="iRunCreateBloodPressureCommand">Runner of CREATE resource command</param>
        /// <param name="iRunDeleteBloodPressureByIdCommand">Runner of DELETE resource command</param>
        ...
        /// <param name="iRunPatchBloodPressureCommmand">Runner for changing main doctor ID command.</param>
        /// <param name="iHandleGetDocumentByBloodPressureIdQuery">Handler for retrieving patient's <see cref="DocumentMetadataInfo"/>s.</param>
        /// <param name="mapper">Mapper to convert one type to an other.</param>
        /// <param name="iRunCreateDocumentForBloodPressureCommand">Runner for CREATE document resource commands.</param>
        /// <param name="iHandleGetOneDocumentInfoByBloodPressureIdAndDocumentId">Runner for CREATE document resource commands.</param>
        public BloodPressuresController(ILogger<BloodPressuresController> logger, IUrlHelper urlHelper,
            ...
            IHandleQueryOneAsync<Guid, BloodPressureInfo> getByIdQueryHandler,
            IHandleGetPageOfBloodPressureInfosQuery getManyBloodPressureQueryHandler,
            IRunCreateBloodPressureCommand iRunCreateBloodPressureCommand,
            IRunDeleteBloodPressureByIdCommand iRunDeleteBloodPressureByIdCommand,
            IRunPatchBloodPressureCommand,
            IHandleGetDocumentsByBloodPressureIdQuery iHandleGetDocumentByBloodPressureIdQuery,
            IRunPatchBloodPressureCommand iRunPatchBloodPressureCommmand,
            IRunCreateDocumentForBloodPressureCommand iRunCreateDocumentForBloodPressureCommand,
            IHandleGetOneDocumentInfoByBloodPressureIdAndDocumentId iHandleGetOneDocumentInfoByBloodPressureIdAndDocumentId) :
            base(logger, apiOptions, getByIdQueryHandler, getManyBloodPressureQueryHandler, iRunCreateBloodPressureCommand, urlHelper)
        {
            _iRunCreateBloodPressureCommand = iRunCreateBloodPressureCommand;
            _iRunDeleteBloodPressureByIdCommand = iRunDeleteBloodPressureByIdCommand;
            _physiologicalMeasureService = physiologicalMeasureService;
            _prescriptionService = prescriptionService;
            _iRunPatchBloodPressureCommmand = iRunPatchBloodPressureCommmand;
            _iHandleSearchQuery = iHandleSearchQuery;
            _iHandleGetDocumentByBloodPressureIdQuery = iHandleGetDocumentByBloodPressureIdQuery;
            _iRunCreateDocumentForBloodPressureCommand = iRunCreateDocumentForBloodPressureCommand;
            _iHandleGetOneDocumentInfoByBloodPressureIdAndDocumentId = iHandleGetOneDocumentInfoByBloodPressureIdAndDocumentId;
            _mapper = mapper;
        }
        ...
        public async Task<IActionResult> Get([FromQuery] int page, [FromQuery] int pageSize)
        {
            ...
            IPagedResult<BloodPressureInfo> result = await GetAll(pageConfig);
        ...
        public async Task<IActionResult> Delete(Guid id, CancellationToken cancellationToken = default)
        {
            ...
            {
                await _iRunDeleteBloodPressureByIdCommand.RunAsync(new DeleteBloodPressureByIdCommand(id), cancellationToken);
        ...
        {
            Option<IEnumerable<BloodPressureInfo>> output = await MostRecentMeasureAsync<BloodPressure, BloodPressureInfo>(new GetMostRecentPhysiologicalMeasuresInfo { BloodPressureId = id, Count = count });

            return output.Match<IActionResult>(
                some: items => new OkObjectResult(
                    items.Select(x => new BrowsableResource<BloodPressureInfo>
                    {
                        Resource = x,
                        Links = new[]
                            {
        ...
        /// <returns></returns>
        protected override IEnumerable<Link> BuildAdditionalLinksForResource(BloodPressureInfo resource)
                ...
                some: pageOfResult =>

                   {
                       ...
                       string lastPageUrl = pageOfResult.PageCount > 0
                               ? UrlHelper.Action(nameof(Documents), ControllerName, new { PageSize = query.PageSize, Page = pageOfResult.PageCount, id })
                               : null;
