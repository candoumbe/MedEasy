                ...
                new Endpoint
                {
                    ...
                    Forms = new[]
                    {
                        ...
                        new Form
                        {
                            ...
                            Items = new []
                            {
                                new FormField { Name = nameof(PatientInfo.Firstname) },
                                new FormField { Name = nameof(PatientInfo.Lastname) },
                                new FormField { Name = nameof(PatientInfo.MainDoctorId) },
                                new FormField { Name = nameof(PatientInfo.BirthDate) },
                            }
                        }
