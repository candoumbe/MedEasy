...
namespace Patients.API.IntegrationTests
{
    ...
    public class RootControllerTests : IDisposable, IClassFixture<ServicesTestFixture<Startup>>
    {
        ...
        public RootControllerTests(ITestOutputHelper outputHelper, ServicesTestFixture<Startup> fixture)
        {
            ...
            fixture.Initialize(Path.Combine("..", "..", "..", "..", "src", "services", "Patients"), "Development", "Patients.API");
        ...
        [Fact]
        public async Task Calling_ApiIndex_WithJson_Returns_Root_Informations()
        {
            // Arrange
            ...
            RequestBuilder rb = _server.CreateRequest("/")
        ...
        [Fact]
        public async Task Calling_ApiIndex_WithXml_Returns_Root_Informations()
        {
            // Arrange
            RequestBuilder rb = _server.CreateRequest("/")
